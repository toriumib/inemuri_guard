        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              'まぶたと頭の解析は端末の中だけで行い、映像を送信しません。マイクの音も録音しません。'
              '録画するのは、自分で開いたドラレコ（背面カメラ・端末内に保存）だけです。\n\n'
              '車モードの「制限速度を知らせる」は、いる場所のおおよその区画（約 2km 四方）を'
              'OpenStreetMap の地図サーバーへ送って制限速度を引きます（設定で切れます）。\n\n'
